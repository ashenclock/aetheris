...
class EditFileSchema(BaseModel):
    ...
    target_content: str = Field(..., description="The exact existing string in the file to replace")
    replacement_content: str = Field(..., description="The new string to replace it with")
